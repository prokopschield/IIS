    ...
    <Card width="120" tittle="Registrace tábora">
        ...
        <div slot="content">
            ...
            <div class="w-full mb-5">
                <Button buttonClass="btn btn-accent w-20 h-20" on:click={addAttendee}>Přidat pole pro dalšího
                    účastníka
                </Button>
            </div>

            <div class="w-full mb-5">
                <Button buttonClass="btn btn-accent w-20 h-20" on:click={addSupervisor}>Přidat pole pro dalšího
                    vedoucího
                </Button>
            </div>
        ...
        {#if modalVersion === "login"}
            ...
            <form on:submit|preventDefault = {loginHandler}>
                <div style="border-radius: 25px; padding: 20px; background-color: #e2e2e2;">
                    ...
                    <input class="border-2 rounded-full w-80" type="password" placeholder="Vložte Heslo" name="psw"
                           required><br>
                ...
                <button class="btn btn-info sm:btn-sm md:btn-md lg:btn-lg center" type="submit">Přihlásit se</button>
                <br><br>

                <div class="container">
                    <span class="psw text-center"><a on:click={forgotPasswordHandler}>Zapoměli jste heslo?</a></span>
                </div>
            </form>

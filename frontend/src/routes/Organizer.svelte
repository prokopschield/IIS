<script>
	...
	let attendeesOfArray = ["Jan Novák", "Klára Nováková", "David Kernel", "Jan Roztočil", "Emily Nerudová", "Radek Spálený"];
...
<HeroTwo>
	<div><h1 class="text-5xl font-bold">Pokročilé nastavení organizátora</h1><br></div>
	<div><h1 class="text-3xl">Změna názvu tábora</h1><br></div>
	<div>
		<form id="changeCampName" class="space-y-3" on:submit|preventDefault={changeName}>
		...
		<input class="btn btn-primary" type="submit" form="changeCampName" value="Uložit nový název">
	</div>
	<br><br><br>

	<div><h1 class="text-3xl">Přidat další účastníky tábora</h1><br></div>
	<div>
		<form id="addAttendee" class="space-y-3" on:submit|preventDefault={submitAttendee}>
		...
		<div class="w-full mb-5">
			<Button buttonClass="btn btn-accent w-20 h-20" on:click={addAttendee}>Další položku pro dalšího
				účastníka
			</Button>
		</div>
		<input class="btn btn-primary" type="submit" form="addAttendee" value="Přidat účastníky">
	</div>
	<br><br><br>


	<div><h1 class="text-3xl">Přidat další vedoucí tábora</h1><br></div>
	<div><br>
		<form id="addSupervisior" class="space-y-3" on:submit|preventDefault={submitSupervisors}>
		...
		<br>
		<div class="w-full mb-5">
			<Button buttonClass="btn btn-accent w-20 h-20" on:click={addSupervisior}>Další položku pro dalšího
				vedoucího
			</Button>
		</div>
		<input class="btn btn-primary" type="submit" form="addSupervisior" value="Přidat vedoucí/ho">
	</div>
	<br>


	<div><h1 class="text-3xl">Seznam účastníků tábora</h1><br></div>
	...
	<div class="relative overflow-x-auto" style="padding: 30px">
	    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
 	       ...
 	       <tbody>
				{#each attendeesOfArray as nameAttendee} <!-- For cycle for lines-->
